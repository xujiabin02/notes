...
/data/lib/kafka/bin/kafka-consumer-groups.sh --bootstrap-server localhost:9092  --delete --group  repair4_cdp_event
```
...
2022年08月04日 作者: 海源 仕禄 肖恩 鸿洛 启帆 胡荣 李杰 [文章链接](https://tech.meituan.com/2022/08/04/the-practice-of-kafka-in-the-meituan-data-platform.html) 11421字 23分钟阅读
...
![图1-1 Kafka在美团数据平台的现状](.img_kafka/fe3c4d04ea44f0c85ed22f12e778dd60100083.jpg)
...
![图1-2 Kafka在美团数据平台面临的挑战](.img_kafka/09b029578fc89312d349a9c36b2de3cb94494.jpg)
...
![图2-1 Kafka读写延迟优化概览](.img_kafka/f96b61d083650dfc6396fb49372fcaa7218379.jpg)
...
![图2-2 Kafka应用层磁盘均衡](.img_kafka/2a5862e288a6da17813ec44f285b581e138141.jpg)
...
![图2-3 流水线加速](.img_kafka/e14661bfc422d8dd1b01189526b220c996833.jpg)
...
![图2-4-1 迁移问题](.img_kafka/c2ba21e0ddee36ae7bbeb0fcb13c48d5134256.jpg)
...
![图2-4-2 迁移取消](.img_kafka/cde78ff4a088af3f7a0e592b3d1892d0136870.jpg)
...
![图2-5 Fetcher隔离](.img_kafka/31f1a56eaaf40e36fb19e3937a556098117391.jpg)
...
![图2-6 Kafka-Broker分阶段延时统计模型](.img_kafka/2a850430c31dd5de1fec6843886ad11688626.jpg)
...
![图2-7 Consumer异步化](.img_kafka/f6dfa2d4d5f6412aac65a6e0afd1c96d113516.jpg)
...
![图2-8 引入异步拉取线程](.img_kafka/c365b5467fad3ba87afdd83ef2576a8980628.jpg)
...
![图2-9 Raid卡加速](.img_kafka/757f191d80210e733480bf7e5516d34782070.jpg)
...
![图2-10 Cgroup隔离](.img_kafka/0e4e3fc960ee5a5b687935e5b872b807160754.jpg)
...
![图2-11 Page污染引起的性能问题](.img_kafka/73d5969e76c2c371921b2e60d9071da7198373.jpg)
...
![图2-13 KafkaSSD新缓存架构](.img_kafka/4a31c00bbf0d9b0a6d815619f2dbd893250550.jpg)
...
![图2-14 SSD新缓存架构细节优化](.img_kafka/8117ae6b8d500577f9624bc64a171fec37473.jpg)
...
![图3-1 隔离优化](.img_kafka/ea75bd72526e2239871ee19bf61d4d9c126567.jpg)
...
![图3-2 全链路监控](.img_kafka/3d121ef2b41b1a1b1c7c94cb9fe969d5150812.jpg)
...
![图3-3 全链路指标监控](.img_kafka/8f89f67123b9d7506863657a8a24762e62601.jpg)
...
![图3-4 全链路监控指标示例](.img_kafka/952cab594ed8696dcd035b7a47c38509311503.jpg)
...
![图3-5 服务生命周期管理](.img_kafka/bccb204bf43ef4f1ad2ef9e161708d80138582.jpg)
...
![图3-6 TOR容灾挑战](.img_kafka/fbd66f42f316dc154fdc10e12085df3e151452.jpg)
...
![图3-7 TOR容灾](.img_kafka/22b1239c5c25974888855e83b2e35812176982.jpg)
...
[基础研发平台](https://tech.meituan.com/tags/基础研发平台.html), [数据](https://tech.meituan.com/tags/数据.html), [Kafka](https://tech.meituan.com/tags/kafka.html), [慢节点](https://tech.meituan.com/tags/慢节点.html)

\#看看其他

[前一篇: 日志导致线程Block的这些坑，你不得不防](https://tech.meituan.com/2022/07/29/tips-for-avoiding-log-blocking-threads.html)

\#一起聊聊

如发现文章有错误、对内容有疑问，都可以关注美团技术团队微信公众号（meituantech），在后台给我们留言。

![美团技术团队微信二维码](.img_kafka/dc8a757b42b2f6bd12fe8402cc372f041050382.png@1875w_834h_80q)
